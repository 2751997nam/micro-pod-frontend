...
class Utils {
    ...
    public static function sluggify($text, $allowUnder = false) {
        $text = trim($text);
        $charMap = array(
    ...
    public static function parseMessageData($msgDataStr) {
        $data = json_decode($msgDataStr, true);
        return [
    ...
    public static function getPublishMessageData($user, $data) {
        return [
